...
const HARDCODED_ROLE = 'volunteer'
...
export default function InviteVolunteer() {
  ...
  // Live query of all invites for this organization, filtered client-side to volunteers
  useEffect(() => {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Invite a volunteer</h1>
        <p className="text-gray-500 text-sm mt-1">
          Generate an invite link to share with a volunteer.
        </p>
      </div>
