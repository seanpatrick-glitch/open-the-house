// PlacesStep.jsx — Onboarding wizard Step 2 (Places). Placeholder shell built
// in Unit 1; real content (CreatePlaceForm reuse) built in Unit 3.
...
export default function PlacesStep({ onNext, onBack }) {
  return (
    <div>
      <h2 className="text-xl font-semibold text-gray-900 mb-2">Add your places</h2>
