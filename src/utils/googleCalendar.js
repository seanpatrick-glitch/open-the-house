  ...
  const events = [
    {
      ...
      date: dates.phase1,
      description: 'Show Prep Phase 1 begins (4–6 weeks before opening). Planning & Alignment.',
    },
    {
      key:  'phase2',
      summary: `${title} — Phase 2: Resource & Concept`,
      date: dates.phase2,
      description: 'Show Prep Phase 2 begins (3 weeks before opening). Resource & Concept.',
    },
    {
      key:  'phase3',
      summary: `${title} — Phase 3: Ordering & Finalizing`,
      date: dates.phase3,
      description: 'Show Prep Phase 3 begins (2 weeks before opening). Ordering & Finalizing.',
    },
    {
      key:  'phase4',
      summary: `${title} — Phase 4: Install Week`,
      date: dates.phase4,
      description: 'Show Prep Phase 4 begins (1 week before opening). Install Week.',
    },
    {
      key:  'opening',
